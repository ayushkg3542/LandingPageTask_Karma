        ...
        <div class="row">
            <div class="col-lg-6 mb-sm-4">
                <div class="about_image">
                    <img src="{{ url('assets/img/about.webp') }}" class="img-fluid" alt="">
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row my-4">
            <div class="col-lg-6">
                <div class="package_image">
                    <img src="{{ url('assets/img/package.jpg') }}" class="img-fluid" alt="">
                </div>
            </div>
            <div class="col-lg-6">
...
<section class="galley-section" id="gallery">
    <div class="container">
        ...
        <div class="row row-gap-3">
            <div class="col-md-4">
                <img src="{{ url('assets/img/gallery1.webp') }}" class="img-fluid" alt="">
            </div>
            <div class="col-md-4">
                <img src="{{ url('assets/img/gallery2.webp') }}" class="img-fluid" alt="">
            </div>
            <div class="col-md-4">
                <img src="{{ url('assets/img/gallery3.webp') }}" class="img-fluid" alt="">
            </div>
            <div class="col-md-4">
                <img src="{{ url('assets/img/gallery4.webp') }}" class="img-fluid" alt="">
            </div>
            <div class="col-md-4">
                <img src="{{ url('assets/img/gallery5.webp') }}" class="img-fluid" alt="">
            </div>
            <div class="col-md-4">
                <img src="{{ url('assets/img/gallery6.webp') }}" class="img-fluid" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row row-gap-3">
            <div class="col-md-4">
                <div class="card border-0">
                    <img src="{{ url('assets/img/nearBy1.webp') }}" class="card-img-top p-0" alt="">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card border-0">
                    <img src="{{ url('assets/img/nearBy2.webp') }}" class="card-img-top p-0" alt="">
                    <div class="card-body">
                        <div class="card-text p-2 text-center">
            ...
            <div class="col-md-4">
                <div class="card border-0">
                    <img src="{{ url('assets/img/nearBy3.webp') }}" class="card-img-top p-0" alt="">
                    <div class="card-body">
                        <div class="card-text p-2 text-center">
